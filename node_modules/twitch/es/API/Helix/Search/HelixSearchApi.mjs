...
import { HelixUser } from "../User/HelixUser.mjs";
/**
...
var HelixSearchApi = /** @class */ (function (_super) {
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        result = _b.sent();
                        return [2 /*return*/, createPaginatedResult(result, HelixUser, this._client)];
                }
            });
        });
    };
    ...
    HelixSearchApi.prototype.searchChannelsPaginated = function (query, filter) {
        ...
        }, this._client, function (data) { return new HelixUser(data, _this._client); });
    };
