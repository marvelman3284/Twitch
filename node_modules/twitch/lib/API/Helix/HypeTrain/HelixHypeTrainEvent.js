...
var HelixHypeTrainEvent = /** @class */ (function () {
    ...
    Object.defineProperty(HelixHypeTrainEvent.prototype, "lastContribution", {
         ...
         */
        get: function () {
            return new HelixHypeTrainContribution_1.HelixHypeTrainContribution(this._data.last_contribution, this._client);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(HelixHypeTrainEvent.prototype, "topContributions", {
        ...
        get: function () {
            var _this = this;
            return this._data.top_contributions.map(function (cont) { return new HelixHypeTrainContribution_1.HelixHypeTrainContribution(cont, _this._client); });
        },
        enumerable: false,
        configurable: true
    });
